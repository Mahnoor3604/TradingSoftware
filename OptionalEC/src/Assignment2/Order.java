...
public class Order implements Tradable {
    ...
    public Order (String userIn, String productIn, Price priceIn, int originalVolumeIn, BookSide sideIn)
            ...
            throws InvalidPriceOperation
    {
        if (priceIn != null) {
            ...
            throw new InvalidPriceOperation("Null Assignment1.Price.");
        }
    }

    private void setSide (BookSide sideIn)
            throws InvalidBookSideObject
    {
        if (sideIn != null) {
            side = sideIn;
        } else {
            throw new InvalidBookSideObject("Assignment2.BookSide cannot be null");
        }
    }
